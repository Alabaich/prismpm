...
class Elementor_FullWidthSuitesSection extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'FullWidthSuitesSection';
    }

    public function get_title()
    {
        return esc_html__('Full Width Suites Section', 'elementor-addon');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control('title', [
            ...
            'type'  => \Elementor\Controls_Manager::TEXT,
            'default' => '1 Bed Loft In Downtown',
        ]);
        ...
        $repeater->add_control('size', [
            'label' => esc_html__('Size (sq ft)', 'elementor-addon'),
            'type'  => \Elementor\Controls_Manager::TEXT,
            'default' => '547.45',
        ]);

        $repeater->add_control('pet_friendly', [
        ...
        $repeater->add_control('price_period', [
            'label' => esc_html__('Price Period', 'elementor-addon'),
            'type'  => \Elementor\Controls_Manager::TEXT,
            'default' => 'month',
        ]);
                    ...
                    <div class="suite-item">
                        ...
                        <div class="suite-content">
                            <div class="suite-info">
                                <h3 class="suite-title"><?php echo esc_html($suite['title']); ?></h3>
                                ...
                                <div class="suite-tags">
                                    <div class="tag-item">
                                        ...
                                        <span><?php echo esc_html($suite['bedrooms']); ?></span>
                                    </div>
                                    ...
                                    <div class="tag-item">
                                        ...
                                        <span><?php echo esc_html($suite['bathrooms']); ?></span>
                                    </div>
                                    ...
                                    <div class="tag-item">
                                        ...
                                        <span><?php echo esc_html($suite['size']); ?> sq ft</span>
                                    </div>

                                    <?php if ($suite['pet_friendly'] === 'yes') : ?>
                                        <div class="tag-item">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="suite-price-section">
                                <div class="suite-price">
                                    <div class="price-amount"><?php echo esc_html($suite['price']); ?></div>
                                    <div class="price-period"><?php echo esc_html($suite['price_period']); ?></div>
                                </div>
